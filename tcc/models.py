...
class Soundexsearch(models.Model):    #"K" For implementing phonetic search.....
	"""
	** Soundexsearch **
	...
	soundex_address = models.CharField(max_length=255)
	soundex_company = models.CharField(max_length=255)
	soundex_city = models.CharField(max_length=255)
