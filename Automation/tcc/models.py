...
class Organisation(models.Model):
	...
	** Organisation **
	...
	Organisation Class define all fields required to submit detail about Organisation.
...
class Department(models.Model):
	...
	** Department **
	...
	Department Class define all fields required to submit detail about a department for a particular Organisation.
...
class Lab(models.Model):
	...
	** Lab **
	...
	Lab Class define all fields required to submit detail about a LAB of a Department.
...
class Material(models.Model):
	...
	** Material **
	...
	Material Class define all fields required to submit detail about a Material under a Lab.
...
class Test(models.Model):
	...
	** Test **
	...
	Test Class define all fields required to submit detail about a test under a Material.
...
class editClientadd(models.Model):
	...
	** editClientadd **
	...
	editClientadd Class define that which user for which client is adding the performa jobid.
...
class Govt(models.Model):
	...
	** Govt **
	...
	Govt Class define all fields required to submit detail about a organisation Type (Government, Semi-Government or Private).
...
class Payment(models.Model):
	...
	** Payment **
	...
	Payment Class define all fields required to submit detail about Payment type (Cash, Cheque, Online or DD).
...
class EditJob(models.Model):
	...
	**EditJob**
	...
	EditJob Class is define all field required to submit detail about new performa Job.
...
class ClientEditJob(models.Model):
	...
	** ClientEditJob **
	...
	ClientEditJob Class define the materials and tests performed on a performa clientjob.
...
class SuspenceEditJob(models.Model):
	...
	**SuspenceEditJob**
	...
	SuspenceJob Class is used to define all fields required to submit detail about new performa Suspence Job.
...
class TestTotal(models.Model):
	...
	** TestTotal **
	...
	TestTotal Class define all fields required to submit amount detail about a job_id.
...
class TestTotalPerf(models.Model):
	...
	** TestTotalPerf **
	...
	TestTotalPerf Class define all fields required to submit amount detail about a performa job_id.
...
class Bill(models.Model):
	...
	** Bill **
	...
	Bill Class define all fields required to submit detail about a taxes on an amount for a particular job.
...
class BillPerf(models.Model):
	...
	** BillPerf **
	...
	BillPerf Class define all fields required to submit detail about a taxes on an amount for a particular performa job.
...
class Amount(models.Model):
	...
	** Amount **
	...
	Amount Class define all fields required to submit detail about amount and there distribution for a particular Job id.
...
class Distance(models.Model):
	...
	** Distance **
	...
	Distance Class define all fields required to submit detail about a site and its distance for a prticular Job_id.
...
class Suspence(models.Model):
	...
	** Suspence **
	...
	Suspence Class define all fields required to submit detail about a Suspence Job.
...
class Staff(models.Model):
	...
	** Staff **
	...
	Staff Class define all fields required to submit detail about a particular Staff member.
...
class TaDa(models.Model):
	...
	** TaDa **
	...
	TaDa Class define all fields required to submit detail about transport and Daily Allowance for a particular Job id.
...
class Transportation(models.Model):
	...
	** Transportation **
	...
	Transportation Class define all fields required to submit detail about transportation.
...
class Transport(models.Model):
	...
	** Transport **
	...
	Transport Class define all fields required for transportation for a particular job id.
...
class LabReport(forms.Form):
	...
	** LabReport **
	...
	LabReport Form that displays start and end date and thus helps in retrieving data between this date range for a particular material.
